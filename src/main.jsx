...
function HomeScreen({ activePerson, setActivePerson, primaryMemberName, familyList, items, onAdd, onViewTimeline, onOpenRecord, showNotifications, toggleNotifications }) {
